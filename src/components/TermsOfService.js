      ...
      <div className="terms-container">
        ...
        <div>
          ...
          <p>
            ...
            defined under the following conditions. <br /> The following
          ...
          <ul>
            ...
            <li>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Gatsby Investment
            ...
            <li>
              <strong>Website</strong> refers to Titan Market website and linked
              applications.
            </li>
            <li>
        ...
        <div>
          ...
          <p>
            ...
            regarding the use of the Service. <br /> Your access to and use of
            ...
            visitors, users and others who access or use the Service. <br /> By
            accessing or using the Service You agree to be bound by these Terms
            and Conditions. If You disagree with any part of these Terms and
            Conditions then You may not access the Service. <br /> You represent
            that you are over the age of 18. The Company does not permit those
            under 18 to use the Service. <br /> Your access to and use of the
        ...
        <div>
          ...
          <p>
            ...
            limitation if You breach these Terms and Conditions. <br /> Upon
        ...
        <div>
          ...
          <p>
            ...
            through the Service. <br /> To the maximum extent permitted by
            ...
            essential purpose. <br /> Note that we do not guarantee increase in
            sales or revenue to you or your business as a result of using our
            platform. <br /> Some states do not allow the exclusion of implied
        ...
        <div>
          ...
          <p>
            ...
            corrected. <br /> Without limiting the foregoing, neither the
        ...
        <div>
          ...
          <p>
            ...
            determined at Our sole discretion. <br /> By continuing to access or
        ...
        <div>
          ...
          <p>
            ...
            contact us:
            <ul>
              <li>By email: iviacharles@gmail.com</li>
              <li>By phone number: +254-741-460-407 </li>
            </ul>
          </p>
        </div>
      </div>
